...
import { useAuthUser, useLogoutMutation } from "../../features/auth/authQuery.ts";
import { useSidebarData, useMarkNotificationsReadMutation } from "../../features/feed/feedQuery.ts";
      ...
      <div className="container _custom_container">
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <ul className="navbar-nav mb-2 mb-lg-0 _header_nav_list ms-auto _mar_r8">
            ...
            {/* Friend request mock link */}
            <li className="nav-item _header_nav_item">
              <Link className="nav-link _header_nav_link" to="/feed">
            ...
            <li className="nav-item _header_nav_item position-relative">
              <button 
                type="button"
                className="nav-link _header_nav_link _header_notify_btn cursor-pointer border-0 bg-transparent p-0"
                onClick={() => {
              ...
              <div 
                ...
                style={{ display: showNotifications ? "block" : "none", right: 0, top: "100%" }}
              >
                <div className="_notifications_content">
                  ...
                  <div className="_notification_box_right">
                    <button 
                      type="button" 
                      className="_notification_box_right_link text-primary border-0 bg-transparent p-0 fs-7"
                ...
                <div className="_notifications_drop_box" style={{ maxHeight: "350px", overflowY: "auto" }}>
                  <div className="_notifications_all">
                    {notifications.length === 0 ? (
                      <div className="p-3 text-center text-muted">No notifications yet.</div>
                    ) : (
                      notifications.map((notification) => (
                        <div key={notification.id} className={`_notification_box ${!notification.readAt ? "_unread_notification_bg" : ""}`}>
                          ...
                          <div className="_notification_txt">
                            <p className="_notification_para">{notification.text}</p>
          ...
          {currentUser && (
            <div className="_header_nav_profile position-relative">
              <div className="_header_nav_profile_image">
                <img 
                  src={currentUser.avatarUrl || "/assets/images/profile.png"} 
                  alt="Profile" 
                  className="_nav_profile_img" 
                />
              </div>
              <div className="_header_nav_dropdown d-flex align-items-center">
                <p className="_header_nav_para mb-0 me-1">
              ...
              <div 
                ...
                style={{ display: showProfileDrop ? "block" : "none", right: 0, top: "100%" }}
              >
                <div className="_nav_profile_dropdown_info">
                  ...
                  <div className="_nav_profile_dropdown_info_txt">
                    ...
                    <span className="text-muted fs-7">{currentUser.email}</span>
                  </div>
                </div>
                <hr />
                <ul className="_nav_dropdown_list">
                  <li className="_nav_dropdown_list_item">
                    <button 
                      type="button"
                      className="_nav_dropdown_link cursor-pointer d-flex align-items-center justify-content-between w-100 border-0 bg-transparent p-0 text-start"
                      onClick={handleLogout}
                    >
                      <div className="_nav_drop_info d-flex align-items-center">
                        <span className="me-2">
