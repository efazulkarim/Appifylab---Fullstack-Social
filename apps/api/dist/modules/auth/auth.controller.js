...
import { registerUser, loginUser, buildGoogleAuthUrl, handleGoogleCallback, refreshSession, logoutSession, } from "./auth.service.js";
...
export function googleRedirect(_req, res, next) {
    try {
